...
class SudokuBoard:
    ...
    def __init__(self, p=None, q=None, m=None, board=None, filepath=None):
        ...
        if board != None:
            ...
            while True:
                ...
                if self.board[randomRow][randomCol] == 0 and self.isValidValue(
                    randomRow, randomCol, randomAssignment
                ):
    ...
    def __str__(self):
        output = "p:" + str(self.p) + "\tq:" + str(self.q) + "\n"
    ...
    def isValidValue(self, row, col, value):
        ...
        return (
            self.isValidColValue(col, value)
            and self.isValidRowValue(row, value)
            and self.isValidBlock(row, col, value)
        )
